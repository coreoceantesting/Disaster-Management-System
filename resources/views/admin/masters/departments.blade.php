<x-admin.layout>
    ...
    <x-slot name="heading">Departments (विभाग)</x-slot>
                    ...
                    <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    <label class="col-form-label" for="initial">Department Initial(विभाग प्रारंभिक) <span class="text-danger">*</span></label>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="buttons-datatables" class="table table-bordered nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($departments_list as $list)
                                        <tr>
                                            <td>{{ $serialNumber++ }}</td>
                                            <td>{{ $list->name }}</td>
                                            <td>{{ $list->initial }}</td>
                                            <td>
                                                <button class="edit-element btn btn-secondary px-2 py-1" title="Edit Department" data-id="{{ $list->department_id }}"><i data-feather="edit"></i></button>
                                                <button class="btn btn-danger rem-element px-2 py-1" title="Delete Department" data-id="{{ $list->department_id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
    ...
    $("#buttons-datatables").on("click", ".edit-element", function(e) {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error)
                {
                    $("#editForm input[name='edit_model_id']").val(data.department.department_id);
